...
void setup() {
    ...
    M5.Lcd.println("Room_B (Server)");

    BLEDevice::init(SERVER_NAME);
    pServer = BLEDevice::createServer();
    pServer->setCallbacks(new MyServerCallbacks());

    BLEService* pService = pServer->createService("87654321-4321-4321-4321-0987654321ab");
    pService->start();
